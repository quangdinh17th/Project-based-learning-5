  ...
  #define RX_PIN 17
  #define TX_PIN 16
  #define SIGNAL_PIN 4  // GPIO phát tín hiệu
  ...
  void setup() 
  {
    pinMode(SIGNAL_PIN, OUTPUT);  // Cài đặt chân phát tín hiệu
    Serial.begin(9600);
    lcd.init();
    lcd.backlight();
  ...
  void enrollFingerprint(int id) 
  {
    ...
    if (p == FINGERPRINT_OK) 
    {
      ...
      // Gửi tín hiệu mức cao qua opto
      digitalWrite(SIGNAL_PIN, HIGH);
      Serial.println("Gửi tín hiệu mức cao: HIGH");
      Serial.println(1);
      delay(2000); // Display success message for 0.5 seconds
      digitalWrite(SIGNAL_PIN, LOW);
      Serial.println("Gửi tín hiệu mức thấp: LOW");
      Serial.println(0);
    }
     else 
     {
